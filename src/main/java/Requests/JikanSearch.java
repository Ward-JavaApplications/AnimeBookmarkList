...
//    }
//
//    public JikanContainers.JikanAnime getJikanAnime(int id){
//        return gson.fromJson(connectAndGetJsonExact("https://api.jikan.moe/v3/anime/"+id),JikanContainers.JikanAnime.class);
//    }
//    public void getJikanAnimeAsync(int id, JikanContainers.JikanRetriever jikanRetriever){
//        jikanRetriever.retrieveAnime(getJikanAnime(id));
//    }
//    public void getJikanAnimeAsync(String targetName, JikanContainers.JikanRetriever jikanRetriever){
//        jikanRetriever.retrieveAnime(getJikanAnime(targetName));
//    }
//    public JikanContainers.JikanAnime getJikanAnime(String targetName){
//        try {
...
//            JikanContainers.JikanBasicAnimeInfo basicAnimeInfo = gson.fromJson(targetElement.toString(), JikanContainers.JikanBasicAnimeInfo.class);
...
//    }
//    public ArrayList<JikanContainers.JikanBasicAnimeInfo> getSuggestions(String targetName){
//        String json = connectAndGetJsonSearch("https://api.jikan.moe/v3/search/anime?q="+targetName+"&limit=5");
//        List<JikanContainers.JikanBasicAnimeInfo> list = gson.fromJson(json, JikanContainers.JikanBasicAnimeInfo.JikanBasicAnimeInfoList.class).getList();
//        return new ArrayList<JikanContainers.JikanBasicAnimeInfo>(list);
//    }
//
...
//                Managers.MyLogger.log(json.toString());
//                return json.toString();
//            }
//        }
//        catch (Exception e){
//            new Exceptions.ErrorMessage("failed loading anime with the following url " + urlLink);
//            e.printStackTrace();
//            return null;
//        }
//
